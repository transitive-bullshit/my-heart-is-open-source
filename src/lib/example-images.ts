...
const images = [
  ...
  },
  {
    ...
    template: 'billboard',
    prompt:
      `place this billboard into a comic book panel of a dark gritty city, ominous tones, wide angle. high contrast style inspired by Travis Charest, Phil Noto, and Gary Millidge. make sure the billboard is clearly visible.`.trim()
  },
  {
    image: Example8,
    template: 'billboard',
